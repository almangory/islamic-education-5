...
export default function App() {
  ...
  const [quizSelectedLessonId, setQuizSelectedLessonId] = useState<string>('surat-an-naba');
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="block text-[#8E8268] text-xs mt-1 text-right font-medium">
                منهج التربية الإسلامية الشامل والممتع للصف الخامس الابتدائي 🕌
              </p>
            </div>
          </div>
          ...
          !startedConfiguredQuiz ? (
            <div className="max-w-3xl mx-auto bg-[#FAF9F6] border-2 border-[#D48166] rounded-3xl p-8 shadow-xl text-right text-[#4D453E] relative overflow-hidden my-8" id="quiz-configurator-panel">
              ...
              <p className="text-xs text-[#8E8268] mb-8 leading-relaxed font-semibold">
                مرحباً بك في ممر الاختبارات الذكية لطلبة الصف الخامس الابتدائي. هنا يمكنك تخصيص نوع وطبيعة الاختبار الذي تود خوضه، واختيار الدرس أو الوحدة، وتحديد عدد الأسئلة بدقة لتحدي قدراتك وتحصيل النجوم المستحقة!
              </p>
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-[#8E8268] leading-relaxed max-w-xl font-medium">
                        امتحان شامل وموجه مؤلف من ٢٠ سؤالاً جوهرياً يعاود تلخيص سائر الوحدات والكتب الدراسية للصف الخامس الابتدائي. أحرز شرف الإتقان المطلق واحصل على شارات العلم العظيمة والكثير من النجوم!
                      </p>
                    </div>
